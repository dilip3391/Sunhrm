...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('role_in_department', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             ));
        $this->hasColumn('opt_out_of_birthday_mails', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             ));
        $this->hasColumn('check_for_confirmation', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             ));
