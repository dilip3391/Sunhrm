...
<?php //var_dump("In the view foel");exit;?>
<div class="box" id="attendance-summary">
     <div class="head"><h1><?php echo __('Department timesheet report'); ?></h1></div> 
        <div class="inner">
            <?php include_partial('global/flash_messages'); ?>

         <form action="<?php echo url_for("time/displayDepartmentLeadTimesheetSummaryReportCriteria"); ?>" id="employeeSelectForm" 
            ...
            <fieldset>
                <ol>
                    ...
                    <li class="radio">
                            ...
                            <?php echo $form['not_submitted']->render(array("class" => "formSelect")); ?>
                            <?php echo $form['not_submitted']->renderLabel(__('Not Submitted')); ?>
                            
                            <?php echo $form['submitted']->render(array("class" => "formSelect")); ?>
                            <?php echo $form['submitted']->renderLabel(__('Submitted')); ?>
                            
                            <?php echo $form['approved']->render(array("class" => "formSelect")); ?> 
                            <?php echo $form['approved']->renderLabel(__('Approved')); ?>
...
<?php //var_dump($pendingApprovelTimesheets);exit; ?>
...
<script type="text/javascript">
   ...
   /* // This block of code implements the pagination for sinlge-selected-employee timesheets.
...
function downloadBTN(){
    ...
    $(document).ready(function() {
        ...
        $('#resetBtn').on('click',function(){
            ...
            var url = "<?php echo url_for('time/displayDepartmentLeadTimesheetSummaryReportCriteria')?>";
            window.location = url;
        });
