...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'attendance' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
            ...
            'expense' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'attendance' , 'recruitment', 'performance', 'expense');
    ...
    public function save() {
        ...
        foreach ($modules as $key => $value) {
            ...
            if (!empty($value)) {
                ...
                if ($key == 'performance') {
                    $modulesToEnable[] = 'performanceTracker';
                }                
                ...
                if (!in_array($key, $defaultModules)) {
                    ...
                    if ($key == 'performance') {
                        $modulesToDisable[] = 'performanceTracker';
                    } 
