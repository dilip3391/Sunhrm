            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li class="checkbox">
                     ...
                     <li class="checkbox">
                        <?php echo $form['attendance']->renderLabel(__('Enable Attendance module')); ?>
                        <?php echo $form['attendance']->render(); ?>
                    </li>
                    ...
                    <li class="checkbox">
                        <?php echo $form['expense']->renderLabel(__('Enable Expense module')); ?>
                        <?php echo $form['expense']->render(); ?>
                    </li>
