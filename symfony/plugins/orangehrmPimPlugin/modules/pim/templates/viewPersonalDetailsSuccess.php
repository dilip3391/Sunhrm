                ...
                <fieldset>
                    ...
                    <ol>
                        ...
                        <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes") { ?>
                         <li>
                            <?php echo $form['opt_out_of_birthday_mails']->renderLabel(__('Opt out of birthday mails')); ?>
                            <?php echo $form['opt_out_of_birthday_mails']->render(array("class" => "editable")); ?> 
                        </li>
                        <?php } ?>
                        <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes") { ?>
                         <li>
                            <?php echo $form['check_for_confirmation']->renderLabel(__('Confirmation Alert')); ?>
                            <?php echo $form['check_for_confirmation']->render(array("class" => "editable")); ?> 
                        </li>
                        <?php } ?>
                    ...
                    <?php endif; ?>                        
                    <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes") {
                    if ($personalInformationPermission->canUpdate()) : ?>
