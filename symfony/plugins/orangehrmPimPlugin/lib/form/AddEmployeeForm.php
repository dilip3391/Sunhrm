...
class AddEmployeeForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->widgets = array(
            ...
            'emp_work_email' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 50)),
        ...
        $this->widgets['joined_date']->setDefault($this->getOption('joined_date'));
        ...
        $this->setValidators(array(
            ...
            'user_name' => new sfValidatorString(array('required' => true, 'max_length' => 20, 'trim' => true)),
            'emp_work_email'        => new sfValidatorString(array('required' => true, 'trim' => true)),
           ...
           // 'chkLogin' => new sfValidatorString(array('required' => false)),
            'joined_date'           => new sfValidatorDate(array('required' => true)),
            //'user_password' => new sfValidatorString(array('required' => true, 'max_length' => 20, 'trim' => true)),
            /*'re_password' => new sfValidatorString(array('required' => true, 'max_length' => 20, 'trim' => true)),*/
        ...
        $customRowFormats[3] = "<li class=\"line nameContainer\"><label class=\"hasTopFieldHelp\">". __('Full Name') . "</label><ol class=\"fieldsInLine\"><li><div class=\"fieldDescription\"><em>*</em> ". __('First Name') . "</div>\n %field%%help%\n%hidden_fields%%error%</li>\n";
        $customRowFormats[4] = "<li><div class=\"fieldDescription\">". __('Middle Name') . "</div>\n %field%%help%\n%hidden_fields%%error%</li>\n";
        $customRowFormats[5] = "<li><div class=\"fieldDescription\"><em>*</em> ". __('Last Name') . "</div>\n %field%%help%\n%hidden_fields%%error%</li>\n</ol>\n</li>";
    ...
    protected function getFormLabels() {
        $labels = array(
            ...
            'emp_work_email' => __('Email') . '<em> *</em>',
            'joined_date' => __('Joined Date') . '<em> *</em>',
    ...
    public function getEmployee(){
        ...
        $employee->joined_date = $posts['joined_date'];
    ...
    public function save() {
       ...
       // }
        ...
        $emailData =  array('recipientFirstName' =>  $employee->firstName);
        $this->getEmailService()->sendEmailUsingTemplate('accountCreate' , $emailData , $employee->emp_work_email);
    ...
    protected function _handleLdapEnabledUser($postedValues, $empNumber) {
        ...
        $check1             = (empty($password))?true:false;
