...
class EmployeeJobDetailsForm extends BaseForm {
    ...
    public function configure() {
        ...
        $contractUpdateChoices = array(
            self::CONTRACT_KEEP => __('Keep Current'),
        ...
        $this->setWidgets(array(
            ...
            'role_in_department' => new sfWidgetFormInputCheckbox(
                array('value_attribute_value' => '1', 'default' => false)
            ),
        ...
        $this->setDefault('role_in_department', $employee->role_in_department);
        ...
        // Setting the validation conditions for the form.
        $this->setValidators(array(
            ...
            'role_in_department' => new sfValidatorInteger(array('required' => false)),
    ...
    public function getEmployee() {
        ...
        $employee->role_in_department = $this->getValue('role_in_department');
