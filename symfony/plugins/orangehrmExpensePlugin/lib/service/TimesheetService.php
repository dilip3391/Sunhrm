...
class TimesheetService {
    ...
    */
    public function getTimeSheetsByDepartmentAndStatus($selectedDepartment, $selectedMonth, $selectedYear, $selectedStatus, $limit, $offset)
    {
        ...
        return $this->getTimesheetDao()->getTimeSheetsByDepartmentAndStatus($selectedDepartment, $selectedMonth, $selectedYear, $selectedStatus, $offset, $limit);
    }
    ...
    */
    ...
    {
        return $this->getTimesheetDao()->getTimeSheetsByDepartmentAndStatusDateRange($selectedDepartment, $fromDate, $toDate, $selectedStatus, $offset, $limit);
    }
    ...
    */
    ...
    {
        return $this->getTimesheetDao()->getTimeSheetOfEmployee($employeeId, $fromDate, $toDate, $selectedStatus, $limit, $offset);
    }
    ...
    */
    public function getTimesheetForDeparmtmentLead($selectedDepartment, $fromDate, $toDate, $notSubmitted, $submitted, $approved, $limit, $offset)
    {
        ...
        return $this->getTimesheetDao()->getTimesheetForDeparmtmentLead($selectedDepartment, $fromDate, $toDate, $notSubmitted, $submitted, $approved, $offset, $limit);
    }
    ...
    */
    public function getTimeSheetOfEmployeeForDepartmentLead($employeeId, $fromDate, $toDate, $notSubmitted, $submitted, $approved, $limit, $offset)
    {
        ...
        return $this->getTimesheetDao()->getTimeSheetOfEmployeeForDepartmentLead($employeeId, $fromDate, $toDate, $notSubmitted, $submitted, $approved, $limit, $offset);
    }
