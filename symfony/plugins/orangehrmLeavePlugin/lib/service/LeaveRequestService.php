...
class LeaveRequestService extends BaseService {
    ...
    public function getEmployeeAllowedToApplyLeaveTypes(Employee $employee) {
        ...
        try {
            ...
            foreach($leaveTypes as $leaveType) {
                ...
                if( $leaveType->getIsEntitlementNotRequired() ){
    ...
    public function searchLeaveForTimeSheet($empId, $date) {

        return $this->getLeaveRequestDao()->fetchLeaveForTimesheet($empId, $date);
