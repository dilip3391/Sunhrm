...
$dept_head_list = array(2=> array(5, 1700),
                  ...
                  10=>array(1700),
                  11=>array(1700),
                  12=>array(1703, 2067, 1700),
                  13=>array(1705, 2085, 1700),
                  14=>array(5)
                  );
    ...
    if(!empty($timesheet_result)){
      foreach ($timesheet_result as $timesheetInfo) {
        ...
        if(  $state != "APPROVED"  ) {
          ...
          $default_week_info->status = $state;
...
sendEmailToDefaulter($timesheet_defaulter_list);

$defaultersByManagerList = sortDefaultersByManager($timesheet_defaulter_list);

$summary_mail = sendMailToManager($defaultersByManagerList, $conn, $dept_head_list[$dept_id]);
