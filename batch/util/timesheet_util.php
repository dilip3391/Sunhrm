...
define("SMTP_HOST", "192.168.70.75");
define("SMTP_AUTH", "True");
define("SMTP_USERNAME", "hrm@sti.com");
define("SMTP_PASSWORD", 'sun12345');
  ...
  foreach ($default_week_list as $default_week_info) {
    ...
    if($default_week_info->status != 'SUBMITTED'){
       ...
       $tableBody .= " <tr> <td>".$default_week_info->week." - ".$endDate ."</td>
              ...
              <td> <a href= 'http://hrm.sti.com/symfony/web/index.php/time/viewMyTimesheet' >View Timesheet</td>
            </tr>" ;   
    }
...
function sendMailToManager($defaultersByManagerList, $conn, $dept_head_list ){
  ...
  foreach ($defaultersByManagerList as $managerNumber => $timesheet_defaulter_list) {
    ...
    foreach ($managersDetails as $managerInfo){
      ...
      $mail2->Subject = 'Timesheets Notification Email';
      ...
      if( $timsheetInfo ) { 
        ...
        $message =" <html>
                        <body>
                          ...
                          <p>All submitted timesheets needs to be approved. Kindly visit the link to perform the action for the below mentioned timesheet.</br></p>
                            <tr> <td>" .$tableBody." </td>     
                            </tr>
                          <p>For any help, email us at support.hrm@suntechnologies.com </br>
                          <p>Thank you.
      ...
      foreach ($default_week_list as $default_week_info) {
        ...
        if($default_week_info->status !="APPROVED" ){
          ...
          $tableBody .= " <tr> <td>". $emp_timesheet_info->employee_id  ."</td>
                            ...
                            <td>". $default_week_info->status ."</td>
                            <td>". $action_by . "</td>
                            <td> <a href= 'http://hrm.sti.com/symfony/web/index.php/time/viewEmployeeTimesheet' >View Timesheet</td>
                        </tr>" ;   
        }
      }
    } 
...
function sendSummrayMailToHead($summary_mail, $conn , $dept_head_list, $dept_id){
    ...
    if($departmentHeadDetails){
      ...
      foreach ($departmentHeadDetails as $deptHeadDetails){
        ...
        $message =" <html>
                    <body>
                      <p>Hi " .$emp_firstname.",</br></p>
                      <p>Below is the timesheet summary for all employees for ". $deptName ." department, and all submitted timesheet needs to be approved</br></p>
                        <tr> <td>" .$tableBody." </td>     
                        </tr>
                      <p>For any help, email us at support.hrm@suntechnologies.com </br>
                      <p>Thank you.
